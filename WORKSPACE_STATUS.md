...
- **Pagos confirmados con este mecanismo (24 en total, varias tandas del mismo día operativo):**
...
Branch: main
HEAD: 9ad9ec1 (working tree CLEAN, synced with origin/main, salvo el propio commit de cierre de esta acta — ver nota al inicio del archivo)
Last Commits: 9ad9ec1 style(landing): format floating CTA as heading + bulleted levels | d4b7ed5 feat(landing): suspend Workout and Fotógrafo, simplify hero CTA | 2649a61 fix(payments): regenerate expired Mercado Pago and Clip links
