...
- **Pagos confirmados con este mecanismo (25 en total, varias tandas del mismo día operativo):**
...
Branch: main
HEAD: ed39d3f (working tree CLEAN, synced with origin/main, salvo el propio commit de cierre de esta acta — ver nota al inicio del archivo)
Last Commits: ed39d3f docs(workspace): log 5 payments (2 Clip, 3 Mercado Pago) — 2 Dobles Mujeres + 2 Individual + 1 ½ Hybrid Individual Hombre | 9ad9ec1 style(landing): format floating CTA as heading + bulleted levels | d4b7ed5 feat(landing): suspend Workout and Fotógrafo, simplify hero CTA
