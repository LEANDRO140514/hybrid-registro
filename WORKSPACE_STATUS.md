...
Branch: main
HEAD: 24fdbc7 (working tree CLEAN, synced with origin/main, salvo el propio commit de cierre de esta acta — ver nota al inicio del archivo)
Last Commits: 24fdbc7 fix(og): update social card — correct date to 13-15 Nov, remove third-party logo | 9d2de19 feat(copy): fase 2 — reposicionamiento de marca (comunidad, sin geografía en la promesa) | dee73fe feat(seo): SEO/GEO fase 1 — static JSON-LD, llms.txt, AI-bot robots, richer meta
