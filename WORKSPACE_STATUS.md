...
Known Issues:
  ...
  8. RESUELTO (24fdbc7, 2026-09-01): el Project Owner regenero og:image — fecha ahora "13-15 NOV", se elimino un banner de Red Bull que estaba en el composite del fondo. Mismo nombre, 1200x630, ~148KB. Verificado visualmente. Pendiente reverificar el preview real con el Facebook Sharing Debugger tras el deploy de Vercel (por caches de FB/WhatsApp).
