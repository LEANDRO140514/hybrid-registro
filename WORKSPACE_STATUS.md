...
- **Pagos confirmados con este mecanismo (31 en total, varias tandas del mismo día operativo):**
...
| Cecila Arai Manzano Xool + Maria Concepcion Kuuk Bacab | `9ca6104c-66c7-4c21-b602-5a7d979c2135` | ½ Hybrid Dobles Mixto | Fit House | $1,600 MXN | 0028902321 | `6468434f-…` |
| Melina Alejandra Gurrutia Mézquita + Natalia Alvarez + Kenyi Miranda + Camila Gutierrez | `43e18522-1323-41a2-bb0c-661fe9ef695d` | Relay 4 Mujeres | Y si si?! | $3,200 MXN | PZt0iLI4 (Clip) | `89578c83-…` |
| JOSE IVAN MENA CACERES | `1441a888-0e45-4346-8ae3-4b31d34b5ff8` | Individual Hombre (Open) | (sin equipo) | $1,500 MXN | 177461616096 | `86fd471c-…` |
| Alejandra Angulo | `2284b308-b23d-4c61-81ad-8695790ad9a5` | Individual Mujer (Open) | (sin equipo) | $1,500 MXN | PcZZGIU0 (Clip) | `4750807c-…` |
| Reyna Gabriela castillo Avalos + Vanessa Carolina Espinosa Castro | `ed131917-07e8-4f43-a2c3-714ec29e8186` | ½ Hybrid Dobles Mujeres | V&Q | $1,600 MXN | PQJYsqoi (Clip) | `e4c9b7e9-…` |
| Manuel gutierrez sola | `88b896f0-02fa-4699-b31b-d191782acbb5` | Individual Hombre (Open) | (sin equipo) | $1,500 MXN | 177512099186 | `2c995818-…` |
| Aline Angelica Garcia Almaguer | `a6a0132b-728f-4133-b362-9ad3c8288b4d` | ½ Hybrid Individual Mujer | (sin equipo) | $800 MXN | PGg6bo2t (Clip) | `df29d95a-…` |
| Mariana Rodríguez Caceres | `657c9050-98c5-4e95-b8f5-23507b9ff749` | Individual Mujer (Open) | (sin equipo) | $1,500 MXN | PmRz4NjT (Clip) | `0732430b-…` |
| Melissa Saavedra + Luisa Vanessa Díaz | `d2a1c662-f9e7-4e0f-9678-8f84bdddd4ab` | Dobles Mujeres | Hy-girls | $2,500 MXN | PQG3V50W (Clip) | `918fa23e-…` |
| Fernando Santillan + Hugo mendoza | `0b8d586a-4ea6-417d-9ba8-7307d3d3bc91` | Dobles Hombres | (sin equipo) | $2,500 MXN | P9V1Xsva (Clip) | `c11a5f70-…` |
| Camila Hernández + Romina Hernández | `ae883aa8-cfb1-4918-9a94-799329fd37a4` | Dobles Mujeres | (sin equipo) | $2,500 MXN | P31Gokgp (Clip) | `0f000b6a-…` |
| Astrid Berzunza + Sol Sosa | `d0795a44-1783-4fb7-9dd5-8ed4e74b38b0` | Dobles Mujeres | Sol y Astrid de aventura | $2,500 MXN | PoOyrvJZ (Clip) | `b0142955-…` |
| Karla Vaquera | `deb6bfff-49c0-4e46-9ad1-ea66dbd68488` | Individual Mujer (Open) | (sin equipo) | $1,500 MXN | 178749417266 (Mercado Pago) | `2e7da91d-…` |
| Marcelo Guzman Lopez | `9ab5fb25-9108-4993-ab2b-5328bce860c9` | Individual Hombre (Open) | (sin equipo) | $1,500 MXN | 178908621922 (Mercado Pago) | `445a3cc3-…` |
| EDGAR JESUS MOO MONTALVO | `34ddb6cf-c1c5-4e46-9b53-ac85545b0d00` | ½ Hybrid Individual Hombre | (sin equipo) | $800 MXN | 179892539108 (Mercado Pago) | `01a0bd6a-…` |
| Ingrid GUISELLE Rodríguez Pérez + Gabriela Alejandra guillermo yañez | `5cd916b6-40b8-40dc-bb50-d95078dc62a4` | Dobles Mujeres | La guayaba y la tostada | $2,500 MXN | 180098043044 (Mercado Pago) | `01a0c299-…` |
| Daniel Alfonso Dominguez Chavez | `2d6542bb-c836-435e-9496-095cf13fa1cc` | ½ Hybrid Individual Hombre | (sin equipo) | $800 MXN | 179060793651 (Mercado Pago) | `01a0c497-…` |
| María Fernanda Pérez Ramos + Carlos Adrián Pérez Ramos | `cc37137c-ed5c-40f2-8d12-c90d70259751` | Dobles Mixto | Pérez Ramos | $2,500 MXN | P686Y2WQ (Clip) | `01a0c780-…` |
| Helen  Segura + Ivan Segura | `e011e537-4c63-46e1-96a6-63ff53b4cfee` | Dobles Mixto | Topo | $2,500 MXN | 179327045403 (Mercado Pago) | `01a0c9ff-…` |
| Eric Gibellini + Silvana Valencia | `c8bbb131-81d3-4b5a-9e10-054d43540950` | Dobles Mixto | TEAM 305 | $2,500 MXN | 179382058373 (Mercado Pago) | `01a0cfe1-…` |
| Pablo Renay Molina Pérez | `3c83566f-e3f1-4ee3-b9be-09974199f918` | ½ Hybrid Individual Hombre | (sin equipo) | $800 MXN | 180434904522 (Mercado Pago) | `01a0cfe5-…` |
| Dinosca Rondon Rivera + Cherry Sosa Mariz | `cb11b049-8b37-4200-b156-c00b015e396a` | ½ Hybrid Dobles Mujeres | (sin equipo) | $1,600 MXN | PJ28S40j (Clip) | `01a0deaa-…` |

Los treinta y uno localizados por HEX o id completo dado por el usuario, confirmados verbalmente (registro correcto + método de pago) antes de marcar `status='paid'`, con `participants` completo verificado contra la base antes de invocar (regla del incidente, ya aplicada desde el segundo pago en adelante). El noveno pago fue el primero confirmado vía Clip (los ocho anteriores fueron Mercado Pago); la columna se renombró de "Ref. Mercado Pago" a "Ref. de pago" para reflejarlo. Nota del décimo pago: la fila `participants` en la base trae "Xoll" (typo del registrante) mientras que el usuario que reportó el pago escribió "Xool" — se copió tal cual de la base, sin corregir, siguiendo la regla del incidente. Nota del pago 16 (Aline, `a6a0132b`): existe un registro duplicado de la misma persona (`d72294cd`, 2026-09-05, mismo correo/tel) que sigue `pending` — el usuario confirmó el pago sobre el del 2026-09-06 (`a6a0132b`); el duplicado no se tocó. Nota de los pagos 18 y 19 (Melissa `d2a1c662`, Fernando `0b8d586a`, ambos Clip, misma sesión del 2026-09-11): los dos son Dobles y en ninguno de los dos el usuario mencionó a la segunda persona al reportar el pago — se leyeron de `participants` en la base ("Luisa Vanessa Díaz" y "Hugo mendoza" respectivamente) y se confirmaron con él antes de invocar. "Hugo mendoza" se copió tal cual, con la minúscula del registrante. El de Fernando va sin equipo (`team_name` NULL → `teamName: null` en el payload). Nota de los pagos 20–24 (sesión del 2026-09-13 al 2026-09-20): flujo por pago con SELECT del registro → verificación de monto pagado vs. `amount` (los cinco coincidieron) → UPDATE aprobado → SELECT de verificación → invoke aprobado, uno a uno. Los pagos 20 y 21 (Camila `ae883aa8`, Astrid `d0795a44`) fueron Clip; el 22 (Karla `deb6bfff`) se reportó inicialmente como Clip pero el usuario corrigió a Mercado Pago antes del UPDATE, por lo que `notes` dice "via Mercado Pago". Los pagos 22–24 son Mercado Pago (N.° de operación en `mp_payment_id`). Camila va sin equipo (`team_name` NULL); Astrid con equipo "Sol y Astrid de aventura". El pago 24 (Edgar, `34ddb6cf`) es ½ Hybrid (bloque EXPERIENCE) y reutiliza la foto de Individual Hombre según `PRODUCT_IMAGES`; su nombre va en mayúsculas tal cual está en la base. Nota del pago 25 (Ingrid, `5cd916b6`, Mercado Pago, sesión del 2026-09-21): monto verificado ($2,500 = `amount`); Dobles Mujeres con equipo "La guayaba y la tostada"; los nombres de `participants` se copiaron tal cual de la base, con la capitalización irregular del registrante ("Ingrid GUISELLE…", "Gabriela Alejandra guillermo yañez"). Nota del pago 26 (Daniel, `2d6542bb`, Mercado Pago, sesión del 2026-09-21): ½ Hybrid Individual Hombre (bloque EXPERIENCE), monto verificado ($800 = `amount`), sin equipo; reutiliza la foto de Individual Hombre según `PRODUCT_IMAGES`. Nota del pago 27 (María Fernanda, `cc37137c`, Clip, sesión del 2026-09-22): Dobles Mixto con equipo "Pérez Ramos", monto verificado ($2,500 = `amount`); los dos participantes comparten apellido (hermanos, según `participants` de la base). Nota del pago 28 (Helen, `e011e537`, Mercado Pago, sesión del 2026-09-22): Dobles Mixto con equipo "Topo", monto verificado ($2,500 = `amount`); el nombre "Helen  Segura" tiene doble espacio en `participants` — se copió tal cual, sin corregir. Nota de los pagos 29 y 30 (Eric `c8bbb131`, Pablo `3c83566f`, ambos Mercado Pago, sesión del 2026-09-23): Eric es Dobles Mixto con equipo "TEAM 305", monto verificado ($2,500 = `amount`). Pablo es ½ Hybrid Individual Hombre (bloque EXPERIENCE), sin equipo, monto verificado ($800 = `amount`), reutiliza la foto de Individual Hombre según `PRODUCT_IMAGES`. Nota del pago 31 (Dinosca, `cb11b049`, Clip, sesión del 2026-09-26): ½ Hybrid Dobles Mujeres (bloque EXPERIENCE), sin equipo, monto verificado ($1,600 = `amount`); reutiliza la foto de Dobles Mujeres según `PRODUCT_IMAGES`.
...
Branch: main
HEAD: bde0802 (working tree CLEAN, synced with origin/main, salvo el propio commit de cierre de esta acta — ver nota al inicio del archivo)
Last Commits: bde0802 docs(workspace): log 2 payments (Mercado Pago) - Dobles Mixto (Eric Gibellini) + Half Hybrid Individual Hombre (Pablo Molina) | cd8ba40 docs(workspace): log 1 payment (Mercado Pago) — Dobles Mixto, Topo, Helen Segura | 56071cb docs(workspace): log 1 payment (Clip) — Dobles Mixto, Pérez Ramos
...
DEPLOY STATE: origin/main al dia de este cierre de acta, HEAD 2cdcb89 (ver nota al inicio del archivo sobre por que el acta nunca contiene su propio hash). og:image nueva verificada local Y en produccion (MD5 identico contra hybrid-registro.enforma.mx, 1200x630, "13-15 NOV", sin Red Bull); falta pasar el link por el Facebook Sharing Debugger para forzar el refresh del cache de FB/WhatsApp. Fix del service worker (2cdcb89) verificado con `vite preview` + SW real registrado. COPY-MARCA-FASE-2-01 verificado tambien en produccion (build local reproduce el hash del bundle prod index-D7H7SzjQ.js, hero nuevo presente y "mas intenso de Mexico" ausente en el bundle servido). CLIP-RELINK-CONGELA-PRECIOS-01 verificado en dev server Y en produccion: build local reproduce el hash del bundle productivo (index-BqErw_WK.js), los 10 UUIDs nuevos de Clip presentes en el bundle servido y los 10 viejos ausentes, /inscribir muestra precio de lanzamiento. SEO-GEO-FASE-1-01 verificado en dev server Y en produccion (llms.txt/robots.txt/sitemap.xml sirven texto plano, 1 solo JSON-LD parseable con los campos nuevos, twitter:card large, lang es-MX, robots con bots de IA — todo confirmado con curl contra hybrid-registro.enforma.mx). COPY-MARCA-FASE-2-01 y el tweak post-hero (5a214e1) verificados en produccion (bundle index-CZwi5qfH.js reproducido byte a byte, copy nueva presente y vieja ausente en el bundle servido). Hero background sin Red Bull (900217b): storage sirve los 3 webp nuevos (md5 verificado), dev server carga el w1248 nuevo (72582B, 200); pendiente reverificar contra produccion tras el deploy de Vercel. RELANZAMIENTO-NOVIEMBRE-01 no se reverifico contra el dominio productivo con diff de hash (pendiente). send-payment-confirmation verificada 8 veces contra produccion real (unica forma de probarla) — siempre 200 OK, correo entregado via Resend. La migracion de seguridad se verifico en vivo con peticiones reales usando la anon key. El Meta Pixel se verifico con un espia sobre window.fbq durante un envio real de formulario (fila de prueba borrada despues).
...
Known Issues:
  ...
  8. RESUELTO (24fdbc7 og:image + 900217b hero bg, 2026-09-01): (a) el Project Owner regenero og:image — fecha "13-15 NOV", sin banner de Red Bull. Mismo nombre, 1200x630, ~148KB. (b) La misma foto se usaba de fondo del hero (3 webp en InsForge Storage: hero/hero-corredores-multitud-w{400,800,1248}.webp) y tambien traia el Red Bull. Se limpio con borrado generativo el w1248, se derivaron w800 y w400 por reduccion, se reemplazaron los 3 objetos in-place (InsForge Storage NO sobrescribe — hubo que DELETE por REST + re-subir; ver memory de InsForge), y se bumpearon los 3 ?v= en LandingPage.tsx. Variantes -thumb.webp y -w1200.webp del mismo objeto siguen con Red Bull pero NO se referencian en este repo. Pendiente: reverificar el preview de og:image con el Facebook Sharing Debugger tras el deploy (caches de FB/WhatsApp).
...
Pending Decisions:
  ...
  8. RESUELTO (24fdbc7) — og:image regenerada con fecha correcta y sin logo de terceros. Solo queda reverificar el preview con el Facebook Sharing Debugger tras el deploy (caches de FB/WhatsApp).
  ...
  14. RESUELTO (2cdcb89) — service worker navigateFallbackDenylist agregado y verificado con vite preview + SW real.
